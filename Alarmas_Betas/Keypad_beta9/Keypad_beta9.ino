...
void alarmas(){
  if(vz1==1 && vz2==0 && pinpul==1 && digitalRead(z1)==LOW){
      alarmasr();}
  if(vz1==0 && vz2==1 && pinpul==1 && digitalRead(z2)==LOW){
      alarmasr();}
  if(vz1==1 && vz2==1 && pinpul==1 && (digitalRead(z2)==LOW || digitalRead(z1)==LOW)){
      alarmasr();}
  else if(vz1==0 && vz2==0 && pinpul==1 && (digitalRead(z2)==LOW || digitalRead(z1)==LOW)){
      digitalWrite(bocina, LOW);}
}
void alarmasr(){
