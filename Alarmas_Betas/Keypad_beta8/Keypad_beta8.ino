...
void loop() {
  keypad.getKey();
  alarmas();
  if(digitalRead(remoto)==HIGH){delay(1000);buzzerb();alarma();}
}
...
void alarmas(){
  if(vz1==1 && vz2==0 && pinpul==1 && digitalRead(z1)==HIGH){
      alarmasr();}
  if(vz1==0 && vz2==1 && pinpul==1 && digitalRead(z2)==HIGH){
      alarmasr();}
  if(vz1==1 && vz2==1 && pinpul==1 && (digitalRead(z2)==HIGH || digitalRead(z1)==HIGH)){
      alarmasr();}
  else if(vz1==0 && vz2==0 && pinpul==1 && (digitalRead(z2)==HIGH || digitalRead(z1)==HIGH)){
      digitalWrite(bocina, LOW);}
}
void alarmasr(){
