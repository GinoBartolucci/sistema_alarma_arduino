...
void keypadEvent(KeypadEvent eKey){
  switch (keypad.getState()){
    ...
    Serial.print("Pressed: ");//Aparece la tecla precionada en el monitor serial
    Serial.println(eKey);
    switch (eKey){
...
//////////////VOID PARA SIMPLIFICAR EL MOSTRAR PASS EN LCD//////////////
void imppasslcd(){
  lcd.clear();
  lcd.setCursor(0,0);
...
//////////////VOID PARA SIMPLIFICAR EL MOSTRAR PASS EN LCD//////////////
//////////VERIFICA SI SI LAS PASS SON CORRECTAS O INCORRECTAS///////////
void checkPassword(){
  if (password.evaluate()){//si la contraseña es correcta
    ...
    delay(2000);//espera 2 segundo prendido
  ...
  switch(npasse){//depende cuantas veces llego a ser incorrecta la clave
    ...
    case 3:
      ...
      delay(2000);
      //hacer void para el punk
      break;
  }
  }
}
//////////VERIFICA SI SI LAS PASS SON CORRECTAS O INCORRECTAS///////////
///////////////////SIMPLIFICACION PASS INCORRECTAS//////////////////////
